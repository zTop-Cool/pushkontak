...
const client = makeWASocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["Bug Simple Sky", "Dekstop", "3.0"]})
console.log(color('[ Base Ori zSky ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : zSky-MD\n➸ Creator : Sky\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : zSky`\n➸ My Instagram : zSky\n))
